...
export const ObtnerDocumentos = (sql: Request): Promise<Documento[]> => {
  ...
  SELECT TOP 1 D.IdDocumento as CodVenta,D.VentaId, D.NombreComercialReceptor as cliente, D.TipoDocumentoReceptor as TipoDocCliente, D.NroDocumentoReceptor as NroDocCliente,
    ...
    D.TotalVenta as TotalDocumento,D.CalculoIgv as Porcentaje, D.GuiaRemision as NGuia, 0 as TipoCambio,D.FECHA_HORA_REF_NC as FechaReferencia,
    ...
    D.FECHA_HORA_REF_NC as HoraReferencia ,D.OBSERVACION as otros, null as Detraccion, null as PorcDetraccion, null as MontoDetraccion, null as RegimenPercepcion,
